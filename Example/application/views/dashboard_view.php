        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                    <div class="inner">
                        <h3><?php echo $user_total['total_user']; ?></h3>
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-yellow">
                    <div class="inner">
                        <h3><?php echo $truck_total['total_truck']; ?></h3>
                        <p>Truck Registrations</p>
                    </div>
                    <div class="icon">
                        <i class="ion ion-stats-bars"></i>
                    </div>
                    <a href="<?php echo base_url(); ?>truck" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
                <!-- small box -->
                <div class="small-box bg-red">
                    <div class="inner">
                        <h3><?php echo $item_total['total_item']; ?></h3>
                        <p>Total Items</p>
                    </div>
                    <div class="icon">
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-aqua">
                    <div class="inner">
                        <h3><?php echo $category_total['total_category']; ?></h3>
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-aqua">
                    <div class="inner">
                        <h3><?php echo $order_total['total_order']; ?></h3>
                        <p>Total Orders</p>
                    </div>
                    <div class="icon">
                        <i class="ion ion-bag"></i>
