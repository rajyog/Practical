...
<html>
    <head>
        ...
        <title>All Example | Dashboard</title>
...
<!--        <script type="text/javascript" src="<?php echo base_url(); ?>assets/bootstrap-material-datetimepicker-gh-pages/js/bootstrap-material-datetimepicker.js"></script>-->
    ...
    <style>
        #loading 
        {
            ...
            bottom:0;
            left:0;
            background: rgba(0,0,0,0.5) url(<?= loader_loading_url; ?>) no-repeat 50% 50%;
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a  class="logo">
                    ...
                    <span class="logo-lg">All Example</span>
                </a>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="<?php echo ($contoller == 'promocode') ? 'active' : ''; ?>">
                            <a href="<?php echo base_url(); ?>promocode">
                                <i class="fa fa-fw fa-ticket"></i> <span>Offer Code List</span> 
                            </a>
                        </li>
     <!--                        <li class="treeview">
                                                    <a href="#">
